...
const Products = () => {
  ...
  useEffect(() => {
    fetch("https://young-sea-60382.herokuapp.com/products")
  ...
  const handleDeleteProduct = (id) => {
    ...
    fetch(`https://young-sea-60382.herokuapp.com/deleteProduct/${id}`, {
      method: "DELETE",
  ...
  const handleAddToCart = (index) => {
    ...
    fetch(`https://young-sea-60382.herokuapp.com/addOrders`, {
      method: "POST",
      headers: { "content-type": "application/json" },
